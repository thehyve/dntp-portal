...
public class LabRequestService {
    ...
    public void transferLabRequestData(
            @NotNull LabRequestRepresentation labrequest,
        ...
        labrequest.setStatus((String)taskVariables.get("labrequest_status"));
        labrequest.setDateCreated(task.getCreateTime());
        ...
        labrequest.setRequesterId(variables.get("requester_id") == null ? "" : variables.get("requester_id").toString());
        Long userId = null;
        try { userId = Long.valueOf(labrequest.getRequesterId()); }
        catch(NumberFormatException e) {}
        if (userId != null) {
            User user = userRepository.findOne(userId);
            if (user != null) {
                labrequest.setRequesterName(RequestFormService.getName(user));
                labrequest.setRequesterEmail(user.getContactData().getEmail());
            }
        }
        ...
        labrequest.setExcerptListRemark(properties.getExcerptListRemark());
        ...
        labrequest.setExcerptList(excerptList);
    }
