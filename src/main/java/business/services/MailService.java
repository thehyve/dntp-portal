...
public class MailService {
    ...
    static final String activationEmailTemplate =
            ...
            + "Your account details like: name, e-mail adress, phone number will be stored in the PALGA portal.\n"
            + "By activating your account, you agree with processing and storage of your provided data in accordance with the PALGA privacy policy.\n"
            + "\n"
            + "When you are not activating your account within 3 months, your data will be deleted.\n"
            + "To lodge a complaint you can contact: dpo@palga.nl\n"
