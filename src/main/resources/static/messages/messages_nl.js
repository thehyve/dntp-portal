...
(function(hasModuleExports, hasWindow) {
    ...
    var _messages_nl = {
        ...
        'Required data and/or materials': 'Benodigde data en/of materialen',
        'popover: Required data and/or materials': 'Benodigde data en/of materialen. Voor uitleg over PALGA-gegevens, bijv. welke gegevens een excerpt bevat, zie <a target="_blank" tabindex="-1" href="http://www.palga.nl/gegevensaanvragen/zoekvragen.html">www.palga.nl/gegevensaanvragen/zoekvragen.html</a>.',
        ...
        'Exploratory request':'Oriënterende zoekvraag (OZV)',
        'National request':'Landelijke zoekvraag (LZV)',
        'Local request': 'Lokale zoekvraag',
        'Cohort': 'Cohort',
        'National T-nr list': 'Tnr-lijst landelijk',
        'Local T-nr list': 'Tnr-lijst lokaal',
        'Intermediary procedure previous national request': 'Intermediairprocedure eerdere LZV',
        'Update previous national request': 'Update eerdere LZV',
