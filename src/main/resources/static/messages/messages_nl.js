...
(function(hasModuleExports, hasWindow) {
    ...
    var _messages_nl = {
        ...
        'Send notification to requester and hub users.': 'Notificatie versturen naar de aanvrager en hubmedewerker',
        'Send notification to the requester.': 'Notificatie versturen naar de aanvrager.',
        'Send notification to the lab and hub users.' : 'Notificatie versturen naar de lab en hubmedewerkers.',
