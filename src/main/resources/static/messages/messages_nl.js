...
(function(hasModuleExports, hasWindow) {
    ...
    var _messages_nl = {
        ...
        'Send notification to the requester (CC hub users, if applicable).': 'Notificatie versturen naar de aanvrager (CC hub gebruikers, als relevant)',
        'Send notification to the lab (CC hub users, if applicable).': 'Notificatie versturen naar het lab (CC hub gebruikers, als relevant).',
