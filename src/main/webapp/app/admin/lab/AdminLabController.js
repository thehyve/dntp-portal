...
angular.module('ProcessApp.controllers')
    .controller('AdminLabController',['$rootScope', '$scope', '$location', '$modal', '$alert', 'Lab', '$log', '$templateCache',
        function ($rootScope, $scope, $location, $modal, $alert, Lab, $log, $templateCache) {
            ...
            const _templates = {
                'app/admin/lab/editlab.html': require('./editlab.html')
            };
