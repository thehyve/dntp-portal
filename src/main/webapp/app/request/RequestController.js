...
angular.module('ProcessApp.controllers')
    .controller('RequestController',['$rootScope', '$scope', '$modal', '$location', '$route',
        ...
        if ($route.current.originalPath.endsWith('/agreementform')) {
            $scope.loadTemplate();
        ...
        var _templates = {
            'app/request/approvals.html': require('./approvals.html'),
            'app/request/comments.html': require('./comments.html'),
            'app/request/edit-request.html': require('./edit-request.html'),
            'app/request/print-requests.html': require('./print-requests.html'),
            'app/request/request-contents.html': require('./request-contents.html'),
            'app/request/request-review.html': require('./request-review.html'),
            'app/request/selection.html': require('./selection.html'),
            'app/request/upload-file.html': require('./upload-file.html'),
        };
